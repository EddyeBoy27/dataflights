...
O projeto com o codinome _dataflights_. Nesse projeto, foi praticado todos os conceitos de **MongoDB** já ensinados até aqui. Chamaremos esse banco de  `dataFlights`. As instruções de como restaurar o banco podem ser lidas a seguir.
...
A seguir, tem-se uma série de desafios com diferentes níveis de complexidade. Cada desafio foi resolvido em seu arquivo próprio.

---

## Desafios

Foram montadas queries para encontrar as informações dos desafios a seguir.
